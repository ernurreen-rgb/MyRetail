...
packaged PostgreSQL head остаётся `20260716_04`.
...
## Открытая граница после 7C

Phase 7C закрывает durable cancellation и её cash compensation. Phase 7D должна завершить
общую проверку frozen shift snapshot и сериализацию всех оставшихся комбинаций
sale/create-return/cancel-return/close, не меняя storage/API contract без отдельного
решения Ернура.
